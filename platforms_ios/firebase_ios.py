...
def get_event_log(number_arguments: int = 0, term1:str = None, term2:str = None):
    ...
    Args:
        ...
        term1 (str, optional): First search term/correspondence. Defaults to None.
        term2 (str, optional): Second search term/correspondence. Defaults to None.
    """
        ...
        if continue_log == True and not new_event.search(line, re.IGNORECASE):
            ...
            if re_capture_bundle.search(event_log, re.IGNORECASE):
                ...
                if number_arguments == 0:
                    ...
                    print_single_argument(event_log, term1)
                else: # 2
                    print_double_argument(event_log, term1, term2)
...
def print_single_argument(event_log:str, arg1:str):
    """Print the logged events (with an argument passed in the script call).

    Args:
        event_log (str): event logged by the Firebase SDK.
        arg1 (str): search term or match term used in the filter.
    """
    re_terms = re.compile(rf"{arg1}")
...
def print_double_argument(event_log:str, arg1:str, arg2:str):
    """Print the logged events (with two arguments passed in the script call).

    Args:
        event_log (str): event logged by the Firebase SDK.
        arg1 (str): First search term/correspondence.
        arg2 (str): Second search term/correspondence.
    """
    re_terms = re.compile(rf"{arg1}|{arg2}")
